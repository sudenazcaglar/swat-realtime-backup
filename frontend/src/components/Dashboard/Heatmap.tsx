  ...
  return (
    <div className="bg-gray-800 rounded-xl border border-gray-700 p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-white">Sensor Activity Heatmap</h3>
      ...
      <div className="flex-1 bg-gray-900 rounded-lg p-4 overflow-auto">
        <div className="min-w-max">
          <div className="grid gap-1 mb-4" style={{ gridTemplateColumns: `140px repeat(${timeSlots.length}, 1fr)` }}>
            {/* Header row */}
            <div className="text-xs font-medium text-gray-400 p-2">
              Sensors / Time
            </div>
            {timeSlots.map(time => (
              <div key={time} className="text-xs text-gray-400 text-center p-1 min-w-[30px]">
                {time}
              </div>
            ))}
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: anomaly ? '0 0 8px rgba(239, 68, 68, 0.5)' : 'none'
                      }}
                    >
                      {/* Tooltip */}
